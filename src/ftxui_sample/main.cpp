...
// configuration step. It creates a namespace called `LearnCppBestPractice`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", LearnCppBestPractice::cmake::project_name, LearnCppBestPractice::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", LearnCppBestPractice::cmake::project_version);
      return EXIT_SUCCESS;
    }
